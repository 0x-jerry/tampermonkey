...
// @version      1.0.3
// @updateURL    https://raw.githubusercontent.com/0x-jerry/tampermonkey/refs/heads/gh-pages/ytb-bg.user.js
// @downloadURL  https://raw.githubusercontent.com/0x-jerry/tampermonkey/refs/heads/gh-pages/ytb-bg.user.js
...
(function() {
	...
	*/
	...
	run(async () => {
		...
		if (IS_YOUTUBE) loop(pressKey, 6e4, 1e4);
		function pressKey() {
			const key = 18;
		...
		function getRandomInt(aMin, aMax) {
			...
			return Math.floor(Math.random() * (Math.floor(aMax) - min)) + min;
		}
	});
	//#endregion
})();
