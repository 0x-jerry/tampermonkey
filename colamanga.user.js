...
// @version      1.0.3
// @updateURL    https://raw.githubusercontent.com/0x-jerry/tampermonkey/refs/heads/gh-pages/colamanga.user.js
// @downloadURL  https://raw.githubusercontent.com/0x-jerry/tampermonkey/refs/heads/gh-pages/colamanga.user.js
		...
		window.addEventListener("keydown", async (e) => {
			switch (e.key) {
				case "ArrowRight":
					await nextChapter();
					break;
				case "ArrowLeft": await previousChapter();
			}
		});
