...
(function() {
	...
	*/
	...
	//#endregion
	//#region node_modules/eruda/eruda.js
							...
							return (0, c.A)(t, e), (0, r.A)(t, [
								...
								},
								{
									...
									value: function() {
										...
										e > 0 && e !== Infinity ? this.$text.css("max-height", e) : this.$text.css("max-height", "none");
									}
								},
								{
									key: "initTpl",
						...
						t = function(e, t) {
							return JSON.stringify(e, (n = [], l = [], function(e, t) {
								if (n.length > 0) {
									...
									u > -1 ? (n.splice(u + 1), l.splice(u, Infinity, e)) : (n.push(this), l.push(e));
									var d = n.indexOf(t);
